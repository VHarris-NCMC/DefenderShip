...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Sprite_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Sprite_t qt_meta_stringdata_Sprite = {
    {
        QT_MOC_LITERAL(0, 6),  // "Sprite"
        QT_MOC_LITERAL(7, 15),  // "updateComponent"
        QT_MOC_LITERAL(23, 0)   // ""
    },
    "Sprite",
    "updateComponent",
...
Q_CONSTINIT static const uint qt_meta_data_Sprite[] = {
...
Q_CONSTINIT const QMetaObject Sprite::staticMetaObject = { {
    ...
    qt_meta_stringdata_Sprite.offsetsAndSizes,
    qt_meta_data_Sprite,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Sprite_t,
        // Q_OBJECT / Q_GADGET
